...
urlpatterns = [
    ...
    path('afpayment/patient/<int:patient_id>/', ConsultationPayListView.as_view(), name='detailconsultation-list-filter'),
    path('afpayment/id/<int:id>/', ConsultationPayListView.as_view(), name='detailconsultation-id-filter'),

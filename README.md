...
| 팀원 | GitHub 프로필 | 설명 |
|:---:|:---:|:---:|
|👑심연준| [GitHub 프로필](https://github.com/cheolsu) | 백엔드 |
| 배지현 | [GitHub 프로필](https://github.com/younghee) | 백엔드 |
| 이정호 | [GitHub 프로필](https://github.com/youngsu) | 프론트엔드 |
| 박현일 | [GitHub 프로필](https://github.com/youngsu) | 프론트엔드 |
| 박정민 | [GitHub 프로필](https://github.com/youngsu) | AI 모델링 |
| 이승연 | [GitHub 프로필](https://github.com/youngsu) | AI 모델링 |
| 윤석일 | [GitHub 프로필](https://github.com/youngsu) | AI 모델링 |
